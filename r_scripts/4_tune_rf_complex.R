...
tic("RF: REC 2") # start clock

# fit model
tune_rf_complex <- rf_wf |> 
...
# save fit
save(tune_rf_complex, tictoc_rf_complex, file = here("results/tune_rf_complex.rda"))

show_notes(tune_rf_complex)
