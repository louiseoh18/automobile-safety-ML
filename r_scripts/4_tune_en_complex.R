...
tic("EN: REC 2") # start clock

# fit model
tune_en_complex <- en_wf |> 
...
# save fit
save(tune_en_complex, tictoc_en_complex, file = here("results/tune_en_complex.rda"))

show_notes(tune_en_complex)
