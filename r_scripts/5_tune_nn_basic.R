...
load(here("recipes/recipe_nn_basic.rda"))
...
# save fit
save(tune_nn_basic, tictoc_nn_basic, file = here("results/tune_nn_basic.rda"))

show_notes(tune_nn_basic)
